...
def MessengerOverview(sessionToken, beforeTimestamp = None):
    headers={"authorization": "Bearer "+sessionToken}
...
def getConversation(sessionToken, conversationID, beforeMessageID = None, messageCount = 50): # messageCount = 50, beforeMessageID = null
    headers={"authorization": "Bearer "+sessionToken}
